...
В S3 отсутствует традиционная файловая иерархия. Папки в интерфейсе представляют собой префиксы в имени ключа объекта.
...
Block all public access: отключён
...
Приватный бакет был создан с настройками по умолчанию, при которых публичный доступ полностью запрещён.
...
После повторной загрузки изменённого файла logo.png в консоли отобразились две версии объекта.
